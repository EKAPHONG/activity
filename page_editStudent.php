				...
				<div class="row">
					...
					<div class="col-md-6">
						<!-- <div class="col-md-10 col-md-offset-1"> -->
							...
							<form action="page_editStudent_save.php" method="POST" role="form">
								<div class="box box-warning">
									...
									<div class="box-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="account_id" value="<?php echo($row_profile["account_id"]); ?>" readonly="">
										</div>
										<div class="form-group">
											<label>ระดับการศึกษา</label>
											<select class="form-control" name="level_id" style="color: #000;background-color: #ffff99" required="">
									...
									<div class="box-body">
										...
										<div class="form-group">
											...
											<div class="input-group form-group date">
												...
												<input type='text' class='form-control pull-right' name='account_birthday' id='datepicker' style='color: #000;background-color: #ffff99' value='<?php echo revert_pattern($row_profile["account_birthday"]); ?>' required=''>
											</div>
											<!-- /.input group -->
										</div>
										<!-- information -->
