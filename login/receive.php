...
if ($msg_uid == "genQrCode") {
	$oid	= $xmlrpc->getOid($server, $app_id, $secret, $uid);
	header("Location: ../qrcode/receive.php?oid=$oid");
}

elseif (isset($_SESSION["account_username"]) AND ($_SESSION["account_type"] != "Students")) {
