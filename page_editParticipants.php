			...
			<section class="content container-fluid">
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						...
						<?php
						if (($_GET["activity_id"]) AND ($_GET["account_id"]) AND ($_GET["status"] == "success")) {
							?>
							<div class="alert alert-success alert-dismissible">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								<h4><i class="icon fa fa-check"></i> สำเร็จ!</h4>
								ลบรายการผู้เข้าร่วมกิจกรรมเรียบร้อยแล้ว
							</div>
							<?php
						}
						?>
						...
						<?php
						if (($_GET["activity_id"]) AND ($_GET["account_id"]) AND ($_GET["status"] == "fail")) {
							?>
							<div class="alert alert-danger alert-dismissible">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
								<h4><i class="fas fa-times"></i> ผิดพลาด!</h4>
										...
										<tbody>
											...
											while ($row_joins = $joins->fetch()) {
												...
												<tr>
													...
													<td style="text-align: center;"><a href="page_editParticipants_delete.php?activity_id=<?php echo($row_activity["activity_id"]); ?>&account_id=<?php echo($row_joins["account_id"]); ?>"><button type="button" class="btn btn-block btn-warning btn-xs"><i class="fas fa-trash-alt"></i> ลบ</button></a>
													</td>
												</tr>
												<?php
											}
