...
if ($count == 1) {
	...
	header("Location: page_pre-transcript.php?account_id=" . $resualt["account_id"] . "");
}
?>
<!DOCTYPE html>
<html>
										...
										<tbody>
											...
											while ($row_student = $student->fetch()) {
												...
												<tr>
													...
													<td><a href="page_pre-transcript.php?account_id=<?php echo($row_student["account_id"]) ?>"><button type="button" class="btn btn-block btn-warning btn-xs">เลือก</button></a></td>
												</tr>
												<?php
											}
											?>
