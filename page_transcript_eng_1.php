...
$table.='
            <table autosize="1" class="border-collapse" width="100%">
                <tr>
                    <td class="font-11pt text-center line-bt line-bb">รหัสกิจกรรม</td>
                    <td class="font-11pt text-center line-bt line-bb">ชื่อกิจกรรม</td>
                    <td class="font-11pt text-center line-bt line-bb">หน่วยกิจกรรม</td>
                    <td class="font-11pt text-center line-bt line-bb">ผลกิจกรรม</td>
                </tr>
';

$table.='
                <tr>
                    <td class="font-11pt" colspan="4"><b>กิจกรรมบังคับ</b></td>
                </tr>
';
...
while ($row_sql1 = $sql1->fetch()) {
    ...
    $table.= '
                <tr>
                    ...
                    <td class="font-10pt align-top">' . $text . '</td>
...
$table.='
                <tr>
                    <td align="right" class="font-11pt" colspan="4"><b>' . $row_1 . ' กิจกรรม ' . $total_1 . ' หน่วย&nbsp;<b/></td>
                </tr>
                <tr>
                    <td class="font-11pt" colspan="4">&nbsp;</td>
                </tr>
';

$table.='
                <tr>
                    <td class="font-11pt" colspan="4"><b>กิจกรรมบังคับเลือก</b></td>
                </tr>
';
...
$table.='
                <tr>
                    <td align="right" class="font-11pt" colspan="4"><b>' . $row_2 . ' กิจกรรม ' . $total_2 . ' หน่วย&nbsp;<b/></td>
                </tr>
                <tr>
                    <td class="font-11pt" colspan="4">&nbsp;</td>
                </tr>
...
$table.='
                <tr>
                    <td class="font-11pt" colspan="4"><b>กิจกรรมเลือกเข้าร่วม</b></td>
                </tr>
';

$table.='
                <tr>
                    <td class="font-11pt" colspan="4"><b>ด้านการส่งเสริมและพัฒนาบุคลิกภาพ</b></td>
                </tr>
';
...
while ($row_sql3_1 = $sql3_1->fetch()) {
    ...
    $table.= '
                <tr>
                    ...
                    <td class="font-10pt align-top">' . $text . '</td>
                    <td class="font-10pt text-right align-top">' . $row_sql3_1["activity_unit"] . '</td>
                    <td class="font-10pt text-center align-top">ผ</td>
                </tr>
    ';
    // นับจำนวนกิจกรรม
...
$table.='
                <tr>
                    <td class="font-11pt" colspan="4"><b>ด้านการส่งเสริมและพัฒนาสุขภาพกายและสุขภาพจิต</b></td>
                </tr>
';
...
while ($row_sql3_2 = $sql3_2->fetch()) {
    ...
    $table.= '
                <tr>
                    ...
                    <td class="font-10pt align-top">' . $text . '</td>
                    <td class="font-10pt text-right align-top">' . $row_sql3_2["activity_unit"] . '</td>
                    <td class="font-10pt text-center align-top">ผ</td>
                </tr>
    ';
    // นับจำนวนกิจกรรม
...
$table.='
                <tr>
                    <td class="font-11pt" colspan="4"><b>ด้านการส่งเสริมและพัฒนาทักษะทางวิชาการหรือวิชาชีพ</b></td>
                </tr>
';
...
while ($row_sql3_3 = $sql3_3->fetch()) {
    ...
    $table.= '
                <tr>
                    ...
                    <td class="font-10pt align-top">' . $text . '</td>
                    <td class="font-10pt text-right align-top">' . $row_sql3_3["activity_unit"] . '</td>
                    <td class="font-10pt text-center align-top">ผ</td>
                </tr>
    ';
    // นับจำนวนกิจกรรม
...
$table.='
                <tr>
                    <td class="font-11pt" colspan="4"><b>ด้านการส่งเสริมและพัฒนาคุณธรรม จริยธรรม ค่านิยม</b></td>
                </tr>
';
...
while ($row_sql3_4 = $sql3_4->fetch()) {
    ...
    $table.= '
                <tr>
                    ...
                    <td class="font-10pt align-top">' . $text . '</td>
                    <td class="font-10pt text-right align-top">' . $row_sql3_4["activity_unit"] . '</td>
                    <td class="font-10pt text-center align-top">ผ</td>
                </tr>
    ';
    // นับจำนวนกิจกรรม
...
$table.='
                <tr>
                    <td class="font-11pt" colspan="4"><b>ด้านการส่งเสริมและอนุรักษ์ศิลปวัฒนธรรมและสิ่งแวดล้อม</b></td>
                </tr>
';
...
while ($row_sql3_5 = $sql3_5->fetch()) {
    ...
    $table.= '
                <tr>
                    ...
                    <td class="font-10pt align-top">' . $text . '</td>
                    <td class="font-10pt text-right align-top">' . $row_sql3_5["activity_unit"] . '</td>
                    <td class="font-10pt text-center align-top">ผ</td>
                </tr>
    ';
    // นับจำนวนกิจกรรม
...
$table.='
                <tr>
                    <td align="right" class="font-11pt" colspan="4"><b>' . $row_3 . ' กิจกรรม ' . $total_3 . ' หน่วย&nbsp;<b/></td>
                </tr>
                <tr>
                    <td class="font-11pt" colspan="4">&nbsp;</td>
                </tr>
...
$footer = '<table width="100%"><br /><tr><td class="font-12pt" style="text-align: left" width="50%">แผ่นที่ {PAGENO}/{nbpg}</td><td class="font-12pt" style="text-align: right" width="50%">วันที่ออกเอกสาร ' . $today . '</td></tr></table>';
...
$table_2.='
            ...
            <table width="100%">
                ...
                <tr>
                    <td class="font-10pt" colspan="6"><br />&nbsp;</td>
                </tr>
            </table>
        </td>
    </tr>
