									...
									<table id="example1" class="table">
										<thead>
											<tr>
												...
												<th style="text-align: center;" width="9%">QR Code</th>
										...
										<tbody>
											...
											while ($row_activity = $activity->fetch()) {
												...
												<td style="text-align: center;">
													<form action="webcodecamjs/getEncrypt.php" method="post">
														<button type="submit" name="activity_id" value="<?php echo ($row_activity["activity_id"]); ?>" class="btn btn-info btn-xs"><i class="fas fa-qrcode"></i> เรียกใช้</button>
													</form>
												</td>
												<td style="text-align: center;"><a href="page_editActivity.php?activity_id=<?php echo($row_activity["activity_id"]); ?>"><button type="button" class="btn btn-block btn-warning btn-xs"><i class="fas fa-edit"></i> แก้ไข</button></a>
												</td>
											</tr>
											<?php
										}
