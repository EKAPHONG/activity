...
$pageName = "ลบรายการผู้เข้าร่วมกิจกรรม";
$pageDescription = "";
									...
									<table id="example1" class="table">
										...
										<tbody>
											...
											while ($row_activity = $activity->fetch()) {
												...
												<td style="text-align: center;"><a href="page_editParticipants.php?activity_id=<?php echo($row_activity["activity_id"]); ?>"><button type="button" class="btn btn-block btn-warning btn-xs"><i class="far fa-list-alt"></i> รายละเอียด</button></a>
												</td>
											</tr>
											<?php
										}
