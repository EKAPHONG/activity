...
$pageName = "อนุมัติการเข้าร่วมกิจกรรม";
$pageDescription = "";
						...
						<div class="col-md-12">
							...
							<div class="box box-danger">
								<div class="box-header">
									<h3 class="box-title">รายการกิจกรรม</h3>
								</div>
								<!-- /.box-header -->
										...
										<tbody>
											...
											while ($row_activity = $activity->fetch()) {
												...
												<tr>
													...
													<?php
													$count = $con->query("SELECT COUNT(1) FROM `joins` WHERE `activity_id` LIKE '".$row_activity["activity_id"]."'");
													$row_count = $count->fetch();
													?>
													<td style="text-align: center;"><?php echo(number_format($row_count["COUNT(1)"], 0, '', ',')) ?></td>
													<td style="text-align: center;"><a href="page_approveDetail.php?activity_id=<?php echo($row_activity["activity_id"]); ?>"><button type="button" class="btn btn-block btn-warning btn-xs"><i class="fas fa-edit"></i> แก้ไข</button></a>
													</td>
												</tr>
												<?php
											}
